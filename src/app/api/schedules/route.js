  ...
  try {
    const schedules = db.prepare(`
      SELECT 
        ...
        s.reader_1_id, s.reader_2_id, s.reader_3_id, s.reader_4_id, s.reader_5_id, s.reader_6_id, s.reader_7_id, s.animator_id,
        u1.name as reader_1_name,
        u2.name as reader_2_name,
        u3.name as reader_3_name,
        u4.name as reader_4_name,
        u5.name as reader_5_name,
        u6.name as reader_6_name,
        u7.name as reader_7_name,
      ...
      LEFT JOIN users u5 ON s.reader_5_id = u5.id
      LEFT JOIN users u6 ON s.reader_6_id = u6.id
      LEFT JOIN users u7 ON s.reader_7_id = u7.id
    ...
    return NextResponse.json({ schedules, monthStatus });
  } catch (error) {
